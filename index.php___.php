...
<title>Apply for Online PGDM 2026, Jaipuria Institute of Management</title>
<meta name="description" content="Apply for Jaipuria’s Online PGDM 2026. AICTE-approved, industry-focused curriculum, expert faculty, flexible learning, Attractive Scholarships & career support" />
<meta name="keywords" content="Online PGDM, Online PGDM 2026, PGDM online course, Online management program, Online MBA alternative, AICTE approved online PGDM, Distance PGDM India, Management courses online, PGDM for working professionals, Jaipuria Online PGDM, Jaipuria Institute of Management Online, Jaipuria Online PGDM 2026, Jaipuria Distance Learning, Jaipuria PGDM Online Admission, Online PGDM Jaipuria Noida, Jaipuria Management Programs" />
  ...
  <link rel="icon" type="image/png" href="https://www.jaipuria.ac.in/wp-content/uploads/2022/05/favicon.png">

<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-36BEHV26L9"></script>
<script>
  window.dataLayer = window.dataLayer [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-36BEHV26L9');
</script>

<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-ZMK1GYNXVF"></script>
<script>
  window.dataLayer = window.dataLayer [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-ZMK1GYNXVF');
</script>
...
<link rel="preload" as="image" href="assets/online-jaipuria-admission-mobile.webp" media="(max-width: 639px)">
<link rel="preload" as="image" href="assets/paper-bg.webp" media="(min-width: 1200px)">
...
<body>
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex items-center justify-between h-16 md:h-20 relative">
      ...
      <nav class="hidden lg:flex items-center gap-6">
        <a href="#why-jaipuria" class="text-sm font-medium text-muted-foreground hover:text-[#573865] transition-colors">Why Jaipuria</a>
        <a href="#program" class="text-sm font-medium text-muted-foreground hover:text-[#573865] transition-colors">Program</a>
        <a href="#curriculum" class="text-sm font-medium text-muted-foreground hover:text-[#573865] transition-colors">Curriculum</a>
        <a href="#placements" class="text-sm font-medium text-muted-foreground hover:text-[#573865] transition-colors">Top Recruiters</a>
        <a href="#Eligibility" class="text-sm font-medium text-muted-foreground hover:text-[#573865] transition-colors">Eligibility</a>
        <a href="#success-stories" class="text-sm font-medium text-muted-foreground hover:text-[#573865] transition-colors">Success Stories</a>
      </nav>
      ...
      <button
        id="mobileMenuBtn"
        type="button"
        class="lg:hidden inline-flex items-center justify-center w-10 h-10 rounded-lg border border-gray-200 text-[#573865] hover:bg-gray-50 active:scale-[0.98] transition"
      ...
      <div
        id="mobileMenu"
        class="lg:hidden hidden absolute left-0 right-0 top-full mt-3"
      >
        <div class="rounded-2xl border border-gray-200 bg-white shadow-xl overflow-hidden">
          <div class="px-4 py-3 text-xs font-semibold tracking-wide text-gray-500 bg-gray-50 border-b border-gray-200">
            MENU
          </div>

          <a href="#why-jaipuria" class="mobile-nav-link block px-4 py-3 text-[15px] font-semibold text-gray-800 hover:bg-[#573865]/5 hover:text-[#573865] transition">
            Why Jaipuria
          </a>
          <a href="#program" class="mobile-nav-link block px-4 py-3 text-[15px] font-semibold text-gray-800 hover:bg-[#573865]/5 hover:text-[#573865] transition">
            Program
          </a>
          <a href="#curriculum" class="mobile-nav-link block px-4 py-3 text-[15px] font-semibold text-gray-800 hover:bg-[#573865]/5 hover:text-[#573865] transition">
            Curriculum
          </a>
          <a href="#placements" class="mobile-nav-link block px-4 py-3 text-[15px] font-semibold text-gray-800 hover:bg-[#573865]/5 hover:text-[#573865] transition">
            Top Recruiters
          </a>
          <a href="#Eligibility" class="mobile-nav-link block px-4 py-3 text-[15px] font-semibold text-gray-800 hover:bg-[#573865]/5 hover:text-[#573865] transition">
            Eligibility
          </a>
          <a href="#success-stories" class="mobile-nav-link block px-4 py-3 text-[15px] font-semibold text-gray-800 hover:bg-[#573865]/5 hover:text-[#573865] transition">
            Success Stories
          </a>

          <div class="px-4 py-3 bg-white border-t border-gray-200">
            <a href="#apply-now" class="block w-full text-center bg-[#f5a623] hover:bg-[#e09620] text-white font-extrabold py-3 rounded-xl transition">
              Apply Now
            </a>
          </div>
        </div>
    ...
    <section id="apply-now" class="relative overflow-hidden bg-[#f7f6f3]">
  <img
    src="assets/paper-bg.webp"
    alt=""
    aria-hidden="true"
  ...
  <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-14 lg:py-10 mobile-css-hero">
    <div class="grid lg:grid-cols-12 gap-8 items-center inner">
      <!-- LEFT CONTENT -->
      <div class="lg:col-span-4 hidden sm:block">
        <h1 class="text-4xl sm:text-5xl lg:text-[2.8rem] font-extrabold leading-[1.05] text-black">
            ONLINE PGDM 2026
        </h1>
    <p class="text-black/70 font-medium text-base sm:text-lg py-2"> At-par with On-Campus Degrees
          
  <div class="mb-2 md:mb-4">
                        <span class="inline-block px-4 py-1.5 bg-[#573865]/10 rounded-full text-[#573865] text-s font-medium mb-2">   Marketing, Finance, HR, Operations, Analytics</span>
                    
                    </div></p>


       <!-- KPI GRID (2 x 2, mobile-first, premium) -->
<div class="mt-3 grid grid-cols-2 gap-3 max-w-md">
  
  <div class="backdrop-blur rounded-xl border border-black/10 px-4 py-4 text-center">
    <div class="text-3xl font-extrabold text-black">25%</div>
    <div class="mt-1 text-xs font-semibold text-black/70 uppercase tracking-wide">
      Avg Salary Hike*
    </div>
  </div>

  <div class="backdrop-blur rounded-xl border border-black/10 px-4 py-4 text-center">
    <div class="text-3xl font-extrabold text-black">100%</div>
    <div class="mt-1 text-xs font-semibold text-black/70 uppercase tracking-wide">
      Flexible Learning
    </div>
  </div>
  ...
  <div class="backdrop-blur rounded-xl border border-black/10 px-4 py-4 text-center">
    <div class="text-3xl font-extrabold text-black">275+</div>
    <div class="mt-1 text-xs font-semibold text-black/70 uppercase tracking-wide">
      Recruiters
    </div>
  </div>
  ...
  <div class="backdrop-blur rounded-xl border border-black/10 px-4 py-4 text-center">
    <div class="text-3xl font-extrabold text-black">AICTE </div>
    <div class="mt-1 text-xs font-semibold text-black/70 uppercase tracking-wide">
   Approved
    </div>
  </div>
        ...
        <!-- Accreditation logo cards (same as you had, but styled like reference) -->
<div class="mt-6 grid grid-cols-2 sm:grid-cols-3 gap-4 max-w-3xl">
  
  <!-- NIRF -->
  <div class="accredit-card">
    <img src="assets/NIRF-Ministry-of-Education.webp" alt="NIRF" loading="lazy" decoding="async" width="165" height="157" />
    <span>#41 Rank</span>
  </div>

  <!-- AACSB -->
  <div class="accredit-card">
    <img src="assets/aacsb-logo.webp" alt="AACSB"  loading="lazy" decoding="async" width="343" height="116" />
    <span style="padding-top: 10px;">AACSB Accredited</span>
  </div>

  <!-- NAAC -->
  <div class="accredit-card">
    <img src="assets/naac_logo1.webp" alt="NAAC" loading="lazy" decoding="async" width="417" height="382" />
...
<div class="block sm:hidden bg-white">
  <img
    src="assets/online-jaipuria-admission-mobile.webp"
    width="800"
    height="600"
    fetchpriority="high"
    loading="eager"
    decoding="async"
    alt="Online PGDM 2026"
  >
</div>

      <!-- CENTER / RIGHT IMAGE CUTOUT (DESKTOP ONLY) -->
<div class="hidden lg:block lg:col-span-4 relative order-first lg:order-none">
  <div class="relative w-full">
    
    <!-- soft shadow behind cutout -->
    <div class="absolute -inset-2 rounded-[2rem] blur-2xl bg-black/10"></div>

    <!-- Cutout image -->
    <img
      src="assets/Online-PGDM.webp"
      alt=""
      class="relative w-full max-w-[420px] mx-auto object-contain"
      loading="eager"
      decoding="sync"
    />
      ...
      <!-- RIGHT FORM (your existing form kept as-is) -->
      <div class="lg:col-span-4">
         <div class="enquiry_form">
    
       <!--PHP form -->       
            <div class="form-container"  id="frmContact" style="background:#FFF; border-radius:0 0 20px 20px;">


<div class="bg-[#573865] text-white text-center py-4 px-6" style="border-radius: 20px 20px 0 0;">
            <h3 class="text-lg md:text-xl font-bold">Get Your Brochure</h3>
</div>
<!-- Fonts -->
...
<script type="text/javascript"> var MXLandingPageId = 'ae371ba0-fc25-11f0-ad24-02001702a738'; </script>
<script>
(function() {
  ...
  function loadDependencies() {
    ...
    mainScript.src = "https://dwmbily8o2kmd.cloudfront.net/common/js/lp_main.v3.min.js";
...
document.addEventListener("DOMContentLoaded", function () {
  var sourceMedium = getQueryParam("src_medium");
  var sourceCampaign = getQueryParam("src_campaign");

  if (sourceMedium) {
    document.querySelector('input[name="Source Medium"]').value = sourceMedium;
  }

  if (sourceCampaign) {
    document.querySelector('input[name="Source Campaign"]').value = sourceCampaign;
  }
});
</script> -->
...
<!-- Landing Page Id for Tracking -->
<!-- <script type="text/javascript"> var MXLandingPageId = '6cc9f2a3-2a28-11eb-9782-064afdf7f968'; </script> -->
<!-- Script -->
...
<!-- MOBILE: HERO POSTER + FORM -->

  <!-- <div id="lead-form" class="px-4 py-6">
    <div class="w-full bg-white rounded-2xl shadow-xl overflow-hidden border border-black/5">
      <div class="bg-[#573865] text-white text-center py-4 px-6">
        <h3 class="text-lg font-bold">I am Interested for Online PGDM</h3>
      </div>
      ...
      <div class="p-5">
        <form class="space-y-4">
          <input
            type="text"
            placeholder="Name *"
            class="w-full px-4 py-3 rounded-lg border border-gray-200 bg-white text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#573865]/20 focus:border-[#573865] transition-all"
          />
...
PGDM
          <select
            class="w-full px-4 py-3 rounded-lg border border-gray-200 bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#573865]/20 focus:border-[#573865] transition-all"
          >
          ...
          <button
            type="submit"
            class="w-full bg-[#f5a623] hover:bg-[#e09620] text-white py-3.5 rounded-xl font-bold text-lg transition-colors"
          >
            Submit
          </button>
        </form>
          ...
          <!-- Sticky Bottom Bar -->
<!-- Sticky Bottom Bar -->
<div class="fixed bottom-0 left-0 right-0 z-50 bg-gradient-to-r from-[#000] to-[#000] text-white shadow-2xl">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">

    <!-- Whole bar clickable -->
    <a href="#apply-now" class="block py-3">
      <div class="flex items-center justify-center gap-3 text-center">

        <div class="text-lg sm:text-lg md:text-lg font-extrabold tracking-wide leading-none">
          <span class="whitespace-nowrap">Admissions Open</span>
          <span class="text-white/70 px-2">|</span>

          <!-- Flicker only on this part -->
          <span class="flicker-strong whitespace-nowrap">
           Apply Now
          </span>
        </div>
...
<section class="bg-[#e5e7eb] py-6">
<div class="max-w-6xl mx-auto px-3 sm:px-4 lg:px-6 text-center">

    <p class="text-gray-900 font-extrabold text-2xl sm:text-3xl md:text-4xl lg:text-[28px] leading-tight">
      <span class="inline whitespace-normal sm:whitespace-nowrap">
        Attractive Scholarships Available<span class="text-xs align-super ml-0.5">*</span>
      </span>

      <span class="hidden sm:inline font-normal text-gray-400 mx-1">|</span>

      <span class="inline whitespace-normal sm:whitespace-nowrap">
        Easy Payment Options<span class="text-xs align-super ml-0.5">#</span>
      </span>
    </p>

    <p class="mt-1 text-[14px] text-gray-600 leading-tight">
      <span class="text-[11px] text-gray-500">*#T&amp;C apply.</span>
      <span class="ml-1">For more details, visit</span>
      <span class="ml-1 break-all">online.jaipuria.ac.in</span>
    </p>
   ...
   <!-- Sticky Bottom Bar -->
            ...
            <section id="why-jaipuria" class="py-12 md:py-10 bg-gray-50 scroll-mt-20">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="text-center mb-10 md:mb-8">
                        <h2 class="text-2xl md:text-3xl lg:text-4xl font-bold text-[#573865] mb-3">
                            Why Jaipuria?
                        </h2>
       <!--                  <p class="text-muted-foreground max-w-2xl mx-auto">Trusted legacy, proven results</p> -->
                    </div>           <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 md:gap-6">
                        <div
                            class="group bg-white rounded-2xl p-6 md:p-8 text-center border border-gray-100 shadow-sm hover:shadow-xl hover:border-[#573865]/30 transition-all duration-300 hover:-translate-y-1"
                        >
                            <div
                                class="text-3xl md:text-4xl font-bold text-[#573865] mb-2 group-hover:text-[#f5a623] transition-colors"
                            >
                                30+
                            </div>
                            <div class="text-medium md:text-sm text-muted-foreground font-medium">Years of Legacy</div>
                            <div
                                class="w-12 h-1 bg-[#f5a623]/30 rounded-full mx-auto mt-4 group-hover:w-20 group-hover:bg-[#f5a623] transition-all duration-300"
                            ></div>
                        </div>
                        <div
                            class="group bg-white rounded-2xl p-6 md:p-8 text-center border border-gray-100 shadow-sm hover:shadow-xl hover:border-[#573865]/30 transition-all duration-300 hover:-translate-y-1"
                        >
                            ...
                            <div class="text-medium md:text-sm text-muted-foreground font-medium">Expert Faculty</div>
                            <div
                                class="w-12 h-1 bg-[#f5a623]/30 rounded-full mx-auto mt-4 group-hover:w-20 group-hover:bg-[#f5a623] transition-all duration-300"
                            ></div>
                        </div>
                        ...
                        >
                            ...
                            <div class="text-medium md:text-sm text-muted-foreground font-medium">Recruiters</div>
                            <div
                                class="w-12 h-1 bg-[#f5a623]/30 rounded-full mx-auto mt-4 group-hover:w-20 group-hover:bg-[#f5a623] transition-all duration-300"
                            ></div>
                        </div>
                        ...
                        >
                            ...
                            <div class="text-medium md:text-sm text-muted-foreground font-medium">Alumni Network</div>
                            <div
                                class="w-12 h-1 bg-[#f5a623]/30 rounded-full mx-auto mt-4 group-hover:w-20 group-hover:bg-[#f5a623] transition-all duration-300"
                            ></div>
                        </div>
                        ...
                        >
                            ...
                            <div class="text-medium md:text-sm text-muted-foreground font-medium">
                                Avg Salary Hike
                            </div>
                            <div
                                class="w-12 h-1 bg-[#f5a623]/30 rounded-full mx-auto mt-4 group-hover:w-20 group-hover:bg-[#f5a623] transition-all duration-300"
            ...
            <section class="py-12 md:py-15 bg-white overflow-hidden">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="text-center mb-10 md:mb-8">
                    <!--     <span
                            class="inline-block px-4 py-1.5 bg-[#573865]/10 rounded-full text-[#573865] text-sm font-medium mb-4"
                    ...
                    <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-5 md:gap-6">
                        <div
                            class="group relative bg-gradient-to-b from-white to-gray-50/50 rounded-2xl p-6 border border-gray-100 hover:border-[#573865]/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
                        >
                            <div class="mb-6">
                                <div class="relative w-16 h-16">
                                    <div
                                        class="absolute inset-0 bg-gradient-to-br from-[#573865] to-[#8a6a9a] rounded-xl rotate-6 group-hover:rotate-12 transition-transform duration-300"
                                    ></div>
                                    <div class="absolute inset-1 bg-white rounded-lg flex items-center justify-center">
                                        <div class="w-6 h-8 border-2 border-[#573865] rounded-sm relative">
                                            <div class="absolute top-1 left-1 right-1 h-0.5 bg-[#f5a623]"></div>
                                            <div class="absolute top-2.5 left-1 right-1 h-0.5 bg-[#573865]/30"></div>
                                            <div class="absolute top-4 left-1 right-1 h-0.5 bg-[#573865]/30"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <h3 class="font-bold text-[#573865] text-lg mb-2">Working Professionals</h3>
                            <p class="text-sm text-muted-foreground leading-relaxed">
                                Mid-level managers aiming for senior leadership roles
                            </p>
                            <div
                                class="absolute bottom-0 left-6 right-6 h-0.5 bg-gradient-to-r from-transparent via-[#f5a623] to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                            ></div>
                        </div>
                        <div
                            class="group relative bg-gradient-to-b from-white to-gray-50/50 rounded-2xl p-6 border border-gray-100 hover:border-[#573865]/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
                        >
                            <div class="mb-6">
                                <div class="relative w-16 h-16">
                                    <div
                                        class="absolute inset-0 bg-gradient-to-br from-[#f5a623] to-[#ffc107] rounded-full scale-75 group-hover:scale-90 transition-transform duration-300"
                                    ></div>
                                    <div class="absolute inset-0 flex items-center justify-center">
                                        <div class="relative">
                                            <div class="w-3 h-3 border-2 border-[#573865] rounded-full"></div>
                                            <div class="absolute -right-3 top-1/2 w-4 h-0.5 bg-[#573865]"></div>
                                            <div
                                                class="absolute -right-3 top-1/2 w-2 h-2 border-r-2 border-t-2 border-[#573865] rotate-45 translate-x-1 -translate-y-1"
                                            ></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <h3 class="font-bold text-[#573865] text-lg mb-2">Career Transition</h3>
                            <p class="text-sm text-muted-foreground leading-relaxed">
                                Professionals from technical backgrounds seeking management careers
                            </p>
                            <div
                                class="absolute bottom-0 left-6 right-6 h-0.5 bg-gradient-to-r from-transparent via-[#f5a623] to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                            ></div>
                        ...
                        >
                            <div class="mb-6">
                                <div class="relative w-16 h-16">
                                    <div
                                        class="absolute bottom-0 left-1/2 -translate-x-1/2 w-10 h-6 bg-gradient-to-t from-[#573865] to-[#8a6a9a] rounded-t-full group-hover:h-8 transition-all duration-300"
                                    ></div>
                                    <div
                                        class="absolute top-3 left-1/2 -translate-x-1/2 w-4 h-4 bg-[#f5a623] rounded-full animate-pulse"
                                    ></div>
                                    <div
                                        class="absolute top-1 left-1/2 -translate-x-1/2 w-0.5 h-3 bg-[#f5a623]/50"
                                    ></div>
                                </div>
                            </div>
                            <h3 class="font-bold text-[#573865] text-lg mb-2">Entrepreneurs</h3>
                            <p class="text-sm text-muted-foreground leading-relaxed">
                                Business owners who want to scale their ventures systematically
                            </p>
                            <div
                                class="absolute bottom-0 left-6 right-6 h-0.5 bg-gradient-to-r from-transparent via-[#f5a623] to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                            ></div>
                        ...
                        >
                            <div class="mb-6">
                                <div class="relative w-16 h-16">
                                    <div
                                        class="absolute top-2 left-1/2 -translate-x-1/2 w-10 h-2 bg-[#573865] rounded-sm"
                                    ></div>
                                    <div
                                        class="absolute top-4 left-1/2 -translate-x-1/2 w-8 h-6 bg-gradient-to-b from-[#573865] to-[#8a6a9a] rounded-b-lg group-hover:h-7 transition-all duration-300"
                                    ></div>
                                    <div
                                        class="absolute top-0 left-1/2 -translate-x-1/2 w-3 h-3 bg-[#f5a623] rounded-full -translate-y-1"
                                    ></div>
                                    <div
                                        class="absolute bottom-2 left-1/2 -translate-x-1/2 w-4 h-0.5 bg-white/50"
                                    ></div>
                                </div>
                            </div>
                            <h3 class="font-bold text-[#573865] text-lg mb-2">Fresh Graduates</h3>
                            <p class="text-sm text-muted-foreground leading-relaxed">
                                Graduates looking to build strong business fundamentals
                            </p>
                            <div
                                class="absolute bottom-0 left-6 right-6 h-0.5 bg-gradient-to-r from-transparent via-[#f5a623] to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                            ></div>
          ...
          <section id="career-scroll" class="py-12 md:py-10 bg-gradient-to-br from-[#573865] via-[#6b4a7a] to-[#573865] relative overflow-hidden">
  <div class="absolute inset-0 opacity-10">
    <div class="absolute top-0 left-1/4 w-96 h-96 bg-white rounded-full blur-3xl"></div>
    <div class="absolute bottom-0 right-1/4 w-96 h-96 bg-[#f5a623] rounded-full blur-3xl"></div>
  </div>
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
    ...
    <!-- VIEWPORT -->
    <div class="career-marquee overflow-hidden">
      <!-- TRACK (duplicate content for infinite loop) -->
      <div class="career-track">
        <!-- SET 1 -->
     
        <div class="career-item">
          <div class="group relative bg-white/5 backdrop-blur-sm rounded-2xl p-5 md:p-6 text-center border border-white/10 hover:bg-white/15 hover:border-white/30 transition-all duration-300 hover:scale-105 hover:-translate-y-1 careerheight">
            <div class="relative">
              <div class="w-12 h-12 md:w-14 md:h-14 mx-auto mb-3 rounded-xl bg-white/10 group-hover:bg-[#f5a623] flex items-center justify-center transition-colors duration-300">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                  stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
                  class="lucide lucide-megaphone w-6 h-6 md:w-7 md:h-7 text-[#f5a623] group-hover:text-white transition-colors duration-300">
                  <path d="m3 11 18-5v12L3 14v-3z"></path>
                  <path d="M11.6 16.8a3 3 0 1 1-5.8-1.6"></path>
                </svg>
              </div>
              <span class="text-sm md:text-base text-white font-medium leading-tight block">Marketing Manager</span>
            </div>
          </div>
        </div>
          ...
          <div class="group relative bg-white/5 backdrop-blur-sm rounded-2xl p-5 md:p-6 text-center border border-white/10 hover:bg-white/15 hover:border-white/30 transition-all duration-300 hover:scale-105 hover:-translate-y-1 careerheight">
            <div class="relative">
              <div class="w-12 h-12 md:w-14 md:h-14 mx-auto mb-3 rounded-xl bg-white/10 group-hover:bg-[#f5a623] flex items-center justify-center transition-colors duration-300">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                  stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
                  class="lucide lucide-dollar-sign w-6 h-6 md:w-7 md:h-7 text-[#f5a623] group-hover:text-white transition-colors duration-300">
                  <line x1="12" x2="12" y1="2" y2="22"></line>
                  <path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path>
                </svg>
              </div>
              <span class="text-sm md:text-base text-white font-medium leading-tight block">Finance Manager</span>
            </div>
          </div>
        </div>
          ...
          <div class="group relative bg-white/5 backdrop-blur-sm rounded-2xl p-5 md:p-6 text-center border border-white/10 hover:bg-white/15 hover:border-white/30 transition-all duration-300 hover:scale-105 hover:-translate-y-1 careerheight">
            <div class="relative">
              <div class="w-12 h-12 md:w-14 md:h-14 mx-auto mb-3 rounded-xl bg-white/10 group-hover:bg-[#f5a623] flex items-center justify-center transition-colors duration-300">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                  stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
                  class="lucide lucide-users w-6 h-6 md:w-7 md:h-7 text-[#f5a623] group-hover:text-white transition-colors duration-300">
              ...
              <span class="text-sm md:text-base text-white font-medium leading-tight block">HR Business Partner</span>
            </div>
          </div>
        </div>
          ...
          <div class="group relative bg-white/5 backdrop-blur-sm rounded-2xl p-5 md:p-6 text-center border border-white/10 hover:bg-white/15 hover:border-white/30 transition-all duration-300 hover:scale-105 hover:-translate-y-1 careerheight">
            <div class="relative">
              <div class="w-12 h-12 md:w-14 md:h-14 mx-auto mb-3 rounded-xl bg-white/10 group-hover:bg-[#f5a623] flex items-center justify-center transition-colors duration-300">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                  stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
                  class="lucide lucide-settings w-6 h-6 md:w-7 md:h-7 text-[#f5a623] group-hover:text-white transition-colors duration-300">
                  <path d="M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.39a2 2 0 0 0-.73-2.73l-.15-.08a2 2 0 0 1-1-1.74v-.5a2 2 0 0 1 1-1.74l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z"></path>
                  <circle cx="12" cy="12" r="3"></circle>
                </svg>
              </div>
              <span class="text-sm md:text-base text-white font-medium leading-tight block">Operations Head</span>
            </div>
          </div>
        </div>
          ...
          <div class="group relative bg-white/5 backdrop-blur-sm rounded-2xl p-5 md:p-6 text-center border border-white/10 hover:bg-white/15 hover:border-white/30 transition-all duration-300 hover:scale-105 hover:-translate-y-1 careerheight">
            <div class="relative">
              <div class="w-12 h-12 md:w-14 md:h-14 mx-auto mb-3 rounded-xl bg-white/10 group-hover:bg-[#f5a623] flex items-center justify-center transition-colors duration-300">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                  stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
                  class="lucide lucide-chart-column w-6 h-6 md:w-7 md:h-7 text-[#f5a623] group-hover:text-white transition-colors duration-300">
              ...
              <span class="text-sm md:text-base text-white font-medium leading-tight block">Business Analyst</span>
            </div>
          </div>
        </div>
          ...
          <div class="group relative bg-white/5 backdrop-blur-sm rounded-2xl p-5 md:p-6 text-center border border-white/10 hover:bg-white/15 hover:border-white/30 transition-all duration-300 hover:scale-105 hover:-translate-y-1 careerheight">
            <div class="relative">
              <div class="w-12 h-12 md:w-14 md:h-14 mx-auto mb-3 rounded-xl bg-white/10 group-hover:bg-[#f5a623] flex items-center justify-center transition-colors duration-300">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                  stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
                  class="lucide lucide-package w-6 h-6 md:w-7 md:h-7 text-[#f5a623] group-hover:text-white transition-colors duration-300">
              ...
              <span class="text-sm md:text-base text-white font-medium leading-tight block">Product Manager</span>
            </div>
          </div>
        </div>
          ...
          <div class="group relative bg-white/5 backdrop-blur-sm rounded-2xl p-5 md:p-6 text-center border border-white/10 hover:bg-white/15 hover:border-white/30 transition-all duration-300 hover:scale-105 hover:-translate-y-1 careerheight">
            <div class="relative">
              <div class="w-12 h-12 md:w-14 md:h-14 mx-auto mb-3 rounded-xl bg-white/10 group-hover:bg-[#f5a623] flex items-center justify-center transition-colors duration-300">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                  stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
                  class="lucide lucide-compass w-6 h-6 md:w-7 md:h-7 text-[#f5a623] group-hover:text-white transition-colors duration-300">
                  <path d="m16.24 7.76-1.804 5.411a2 2 0 0 1-1.265 1.265L7.76 16.24l1.804-5.411a2 2 0 0 1 1.265-1.265z"></path>
                  <circle cx="12" cy="12" r="10"></circle>
                </svg>
              </div>
              <span class="text-sm md:text-base text-white font-medium leading-tight block">Strategy Consultant</span>
            </div>
          </div>
        </div>
          ...
          <div class="group relative bg-white/5 backdrop-blur-sm rounded-2xl p-5 md:p-6 text-center border border-white/10 hover:bg-white/15 hover:border-white/30 transition-all duration-300 hover:scale-105 hover:-translate-y-1 careerheight">
            <div class="relative">
              <div class="w-12 h-12 md:w-14 md:h-14 mx-auto mb-3 rounded-xl bg-white/10 group-hover:bg-[#f5a623] flex items-center justify-center transition-colors duration-300">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                  stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
                  class="lucide lucide-pen-tool w-6 h-6 md:w-7 md:h-7 text-[#f5a623] group-hover:text-white transition-colors duration-300">
              ...
              <span class="text-sm md:text-base text-white font-medium leading-tight block">Brand Manager</span>
            </div>
          </div>
        </div>
          ...
          <div class="group relative bg-white/5 backdrop-blur-sm rounded-2xl p-5 md:p-6 text-center border border-white/10 hover:bg-white/15 hover:border-white/30 transition-all duration-300 hover:scale-105 hover:-translate-y-1 careerheight">
            <div class="relative">
              <div class="w-12 h-12 md:w-14 md:h-14 mx-auto mb-3 rounded-xl bg-white/10 group-hover:bg-[#f5a623] flex items-center justify-center transition-colors duration-300">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                  stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
                  class="lucide lucide-chart-line w-6 h-6 md:w-7 md:h-7 text-[#f5a623] group-hover:text-white transition-colors duration-300">
                  <path d="M3 3v16a2 2 0 0 0 2 2h16"></path>
                  <path d="m19 9-5 5-4-4-3 3"></path>
                </svg>
              </div>
              <span class="text-sm md:text-base text-white font-medium leading-tight block">Investment Analyst</span>
            </div>
          </div>
        </div>
          ...
          <div class="group relative bg-white/5 backdrop-blur-sm rounded-2xl p-5 md:p-6 text-center border border-white/10 hover:bg-white/15 hover:border-white/30 transition-all duration-300 hover:scale-105 hover:-translate-y-1 careerheight">
            <div class="relative">
              <div class="w-12 h-12 md:w-14 md:h-14 mx-auto mb-3 rounded-xl bg-white/10 group-hover:bg-[#f5a623] flex items-center justify-center transition-colors duration-300">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                  stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
                  class="lucide lucide-rocket w-6 h-6 md:w-7 md:h-7 text-[#f5a623] group-hover:text-white transition-colors duration-300">
              ...
              <span class="text-sm md:text-base text-white font-medium leading-tight block">Entrepreneur</span>
            </div>
          </div>
        </div>

        <!-- SET 2 (duplicate for infinite loop) -->
        <!-- Copy same 11 items again (kept identical) -->
        <div class="career-item"><div class="group relative bg-white/5 backdrop-blur-sm rounded-2xl p-5 md:p-6 text-center border border-white/10 hover:bg-white/15 hover:border-white/30 transition-all duration-300 hover:scale-105 hover:-translate-y-1  careerheight">

        <div class="relative"><div class="w-12 h-12 md:w-14 md:h-14 mx-auto mb-3 rounded-xl bg-white/10 group-hover:bg-[#f5a623] flex items-center justify-center transition-colors duration-300"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-megaphone w-6 h-6 md:w-7 md:h-7 text-[#f5a623] group-hover:text-white transition-colors duration-300"><path d="m3 11 18-5v12L3 14v-3z"></path><path d="M11.6 16.8a3 3 0 1 1-5.8-1.6"></path></svg></div><span class="text-sm md:text-base text-white font-medium leading-tight block">Marketing Manager</span></div></div></div>
     
        <div class="career-item"><div class="group relative bg-white/5 backdrop-blur-sm rounded-2xl p-5 md:p-6 text-center border border-white/10 hover:bg-white/15 hover:border-white/30 transition-all duration-300 hover:scale-105 hover:-translate-y-1 careerheight"><div class="relative"><div class="w-12 h-12 md:w-14 md:h-14 mx-auto mb-3 rounded-xl bg-white/10 group-hover:bg-[#f5a623] flex items-center justify-center transition-colors duration-300"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-dollar-sign w-6 h-6 md:w-7 md:h-7 text-[#f5a623] group-hover:text-white transition-colors duration-300"><line x1="12" x2="12" y1="2" y2="22"></line><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path></svg></div><span class="text-sm md:text-base text-white font-medium leading-tight block">Finance Manager</span></div></div></div>
     
        <div class="career-item"><div class="group relative bg-white/5 backdrop-blur-sm rounded-2xl p-5 md:p-6 text-center border border-white/10 hover:bg-white/15 hover:border-white/30 transition-all duration-300 hover:scale-105 hover:-translate-y-1 careerheight"><div class="relative"><div class="w-12 h-12 md:w-14 md:h-14 mx-auto mb-3 rounded-xl bg-white/10 group-hover:bg-[#f5a623] flex items-center justify-center transition-colors duration-300"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-users w-6 h-6 md:w-7 md:h-7 text-[#f5a623] group-hover:text-white transition-colors duration-300"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M22 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg></div><span class="text-sm md:text-base text-white font-medium leading-tight block">HR Business Partner</span></div></div></div>
     
        <div class="career-item"><div class="group relative bg-white/5 backdrop-blur-sm rounded-2xl p-5 md:p-6 text-center border border-white/10 hover:bg-white/15 hover:border-white/30 transition-all duration-300 hover:scale-105 hover:-translate-y-1 careerheight"><div class="relative"><div class="w-12 h-12 md:w-14 md:h-14 mx-auto mb-3 rounded-xl bg-white/10 group-hover:bg-[#f5a623] flex items-center justify-center transition-colors duration-300"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-settings w-6 h-6 md:w-7 md:h-7 text-[#f5a623] group-hover:text-white transition-colors duration-300"><path d="M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.39a2 2 0 0 0-.73-2.73l-.15-.08a2 2 0 0 1-1-1.74v-.5a2 2 0 0 1 1-1.74l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z"></path><circle cx="12" cy="12" r="3"></circle></svg></div><span class="text-sm md:text-base text-white font-medium leading-tight block">Operations Head</span></div></div></div>
     
        <div class="career-item"><div class="group relative bg-white/5 backdrop-blur-sm rounded-2xl p-5 md:p-6 text-center border border-white/10 hover:bg-white/15 hover:border-white/30 transition-all duration-300 hover:scale-105 hover:-translate-y-1 careerheight"><div class="relative"><div class="w-12 h-12 md:w-14 md:h-14 mx-auto mb-3 rounded-xl bg-white/10 group-hover:bg-[#f5a623] flex items-center justify-center transition-colors duration-300"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chart-column w-6 h-6 md:w-7 md:h-7 text-[#f5a623] group-hover:text-white transition-colors duration-300"><path d="M3 3v16a2 2 0 0 0 2 2h16"></path><path d="M18 17V9"></path><path d="M13 17V5"></path><path d="M8 17v-3"></path></svg></div><span class="text-sm md:text-base text-white font-medium leading-tight block">Business Analyst</span></div></div></div>
     
        <div class="career-item"><div class="group relative bg-white/5 backdrop-blur-sm rounded-2xl p-5 md:p-6 text-center border border-white/10 hover:bg-white/15 hover:border-white/30 transition-all duration-300 hover:scale-105 hover:-translate-y-1 careerheight"><div class="relative"><div class="w-12 h-12 md:w-14 md:h-14 mx-auto mb-3 rounded-xl bg-white/10 group-hover:bg-[#f5a623] flex items-center justify-center transition-colors duration-300"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-package w-6 h-6 md:w-7 md:h-7 text-[#f5a623] group-hover:text-white transition-colors duration-300"><path d="M11 21.73a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73z"></path><path d="M12 22V12"></path><path d="m3.3 7 7.703 4.734a2 2 0 0 0 1.994 0L20.7 7"></path><path d="m7.5 4.27 9 5.15"></path></svg></div><span class="text-sm md:text-base text-white font-medium leading-tight block">Product Manager</span></div></div></div>
     
        <div class="career-item"><div class="group relative bg-white/5 backdrop-blur-sm rounded-2xl p-5 md:p-6 text-center border border-white/10 hover:bg-white/15 hover:border-white/30 transition-all duration-300 hover:scale-105 hover:-translate-y-1 careerheight"><div class="relative"><div class="w-12 h-12 md:w-14 md:h-14 mx-auto mb-3 rounded-xl bg-white/10 group-hover:bg-[#f5a623] flex items-center justify-center transition-colors duration-300"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-compass w-6 h-6 md:w-7 md:h-7 text-[#f5a623] group-hover:text-white transition-colors duration-300"><path d="m16.24 7.76-1.804 5.411a2 2 0 0 1-1.265 1.265L7.76 16.24l1.804-5.411a2 2 0 0 1 1.265-1.265z"></path><circle cx="12" cy="12" r="10"></circle></svg></div><span class="text-sm md:text-base text-white font-medium leading-tight block">Strategy Consultant</span></div></div></div>
     
        <div class="career-item"><div class="group relative bg-white/5 backdrop-blur-sm rounded-2xl p-5 md:p-6 text-center border border-white/10 hover:bg-white/15 hover:border-white/30 transition-all duration-300 hover:scale-105 hover:-translate-y-1 careerheight"><div class="relative"><div class="w-12 h-12 md:w-14 md:h-14 mx-auto mb-3 rounded-xl bg-white/10 group-hover:bg-[#f5a623] flex items-center justify-center transition-colors duration-300"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-pen-tool w-6 h-6 md:w-7 md:h-7 text-[#f5a623] group-hover:text-white transition-colors duration-300"><path d="M15.707 21.293a1 1 0 0 1-1.414 0l-1.586-1.586a1 1 0 0 1 0-1.414l5.586-5.586a1 1 0 0 1 1.414 0l1.586 1.586a1 1 0 0 1 0 1.414z"></path><path d="m18 13-1.375-6.874a1 1 0 0 0-.746-.776L3.235 2.028a1 1 0 0 0-1.207 1.207L5.35 15.879a1 1 0 0 0 .776.746L13 18"></path><path d="m2.3 2.3 7.286 7.286"></path><circle cx="11" cy="11" r="2"></circle></svg></div><span class="text-sm md:text-base text-white font-medium leading-tight block">Brand Manager</span></div></div></div>
     
        <div class="career-item"><div class="group relative bg-white/5 backdrop-blur-sm rounded-2xl p-5 md:p-6 text-center border border-white/10 hover:bg-white/15 hover:border-white/30 transition-all duration-300 hover:scale-105 hover:-translate-y-1 careerheight"><div class="relative"><div class="w-12 h-12 md:w-14 md:h-14 mx-auto mb-3 rounded-xl bg-white/10 group-hover:bg-[#f5a623] flex items-center justify-center transition-colors duration-300"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chart-line w-6 h-6 md:w-7 md:h-7 text-[#f5a623] group-hover:text-white transition-colors duration-300"><path d="M3 3v16a2 2 0 0 0 2 2h16"></path><path d="m19 9-5 5-4-4-3 3"></path></svg></div><span class="text-sm md:text-base text-white font-medium leading-tight block">Investment Analyst</span></div></div></div>
     
        <div class="career-item"><div class="group relative bg-white/5 backdrop-blur-sm rounded-2xl p-5 md:p-6 text-center border border-white/10 hover:bg-white/15 hover:border-white/30 transition-all duration-300 hover:scale-105 hover:-translate-y-1 careerheight"><div class="relative"><div class="w-12 h-12 md:w-14 md:h-14 mx-auto mb-3 rounded-xl bg-white/10 group-hover:bg-[#f5a623] flex items-center justify-center transition-colors duration-300"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-rocket w-6 h-6 md:w-7 md:h-7 text-[#f5a623] group-hover:text-white transition-colors duration-300"><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.13-.09-2.91a2.18 2.18 0 0 0-2.91-.09z"></path><path d="m12 15-3-3a22 22 0 0 1 2-3.95A12.88 12.88 0 0 1 22 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 0 1-4 2z"></path><path d="M9 12H4s.55-3.03 2-4c1.62-1.08 5 0 5 0"></path><path d="M12 15v5s3.03-.55 4-2c1.08-1.62 0-5 0-5"></path></svg></div><span class="text-sm md:text-base text-white font-medium leading-tight block">Entrepreneur</span></div></div></div>
      </div>
    </div>
  </div>
</section>
            ...
            <section id="placements" class="py-10 md:py-10 bg-white scroll-mt-20 mbsnap">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="text-center mb-10 md:mb-8">
    ...
    <!--   <p class="text-muted-foreground max-w-2xl mx-auto">
        Our graduates are placed in leading companies across industries
      </p> -->
    </div>

    <div class="relative">
      <!-- Buttons kept (optional). Autoplay works regardless. -->
      <button
        id="recruitersPrev"
        class="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-2 md:-translate-x-4 z-10 w-10 h-10 md:w-12 md:h-12 bg-white rounded-full shadow-lg border border-gray-200 flex items-center justify-center hover:bg-[#573865] hover:text-white hover:border-[#573865] transition-all group"
      ...
      <button
        id="recruitersNext"
        class="absolute right-0 top-1/2 -translate-y-1/2 translate-x-2 md:translate-x-4 z-10 w-10 h-10 md:w-12 md:h-12 bg-white rounded-full shadow-lg border border-gray-200 flex items-center justify-center hover:bg-[#573865] hover:text-white hover:border-[#573865] transition-all group"
      ...
      <div class="overflow-hidden mx-6 md:mx-10">
        <div class="space-y-3 md:space-y-4">
          <!-- ROW 1 TRACK -->
          <div
            class="recruitersTrack flex transition-transform duration-500 ease-in-out"
            data-recruiters-track="row1"
            style="transform: translateX(0px);"
          >
            <!-- Cards (keep your styling as-is) -->
            <div class="flex-shrink-0 basis-1/2 sm:basis-1/3 lg:basis-1/5 px-1.5 md:px-2">
              <div class="bg-white rounded-xl border border-gray-200 flex items-center justify-center p-3 md:p-4 h-16 md:h-20 hover:shadow-md hover:border-[#573865]/20 transition-all">
                <img src="./assets/deloitte.webp" alt="Deloitte" loading="lazy" decoding="async" width="250" height="150" class="max-h-10 md:max-h-14 max-w-full object-contain" />
              </div>
            </div>

            <div class="flex-shrink-0 basis-1/2 sm:basis-1/3 lg:basis-1/5 px-1.5 md:px-2">
              <div class="bg-white rounded-xl border border-gray-200 flex items-center justify-center p-3 md:p-4 h-16 md:h-20 hover:shadow-md hover:border-[#573865]/20 transition-all">
                <img src="./assets/pwc.webp" alt="PwC"  loading="lazy" decoding="async" width="250" height="150" class="max-h-10 md:max-h-14 max-w-full object-contain" />
              </div>
            </div>

            <div class="flex-shrink-0 basis-1/2 sm:basis-1/3 lg:basis-1/5 px-1.5 md:px-2">
              <div class="bg-white rounded-xl border border-gray-200 flex items-center justify-center p-3 md:p-4 h-16 md:h-20 hover:shadow-md hover:border-[#573865]/20 transition-all">
                <img src="./assets/genpact.webp" alt="Genpact"  loading="lazy" decoding="async" width="250" height="150" class="max-h-10 md:max-h-14 max-w-full object-contain" />
              </div>
            </div>

            <div class="flex-shrink-0 basis-1/2 sm:basis-1/3 lg:basis-1/5 px-1.5 md:px-2">
              <div class="bg-white rounded-xl border border-gray-200 flex items-center justify-center p-3 md:p-4 h-16 md:h-20 hover:shadow-md hover:border-[#573865]/20 transition-all">
                <img src="./assets/icici-bank.webp" alt="ICICI Bank"  loading="lazy" decoding="async" width="250" height="150"  class="max-h-10 md:max-h-14 max-w-full object-contain" />
              </div>
            </div>

            <div class="flex-shrink-0 basis-1/2 sm:basis-1/3 lg:basis-1/5 px-1.5 md:px-2">
              <div class="bg-white rounded-xl border border-gray-200 flex items-center justify-center p-3 md:p-4 h-16 md:h-20 hover:shadow-md hover:border-[#573865]/20 transition-all">
                <img src="./assets/hdfc-bank.webp" alt="HDFC Bank"  loading="lazy" decoding="async" width="250" height="150" class="max-h-10 md:max-h-14 max-w-full object-contain" />
              </div>
            </div>

            <div class="flex-shrink-0 basis-1/2 sm:basis-1/3 lg:basis-1/5 px-1.5 md:px-2">
              <div class="bg-white rounded-xl border border-gray-200 flex items-center justify-center p-3 md:p-4 h-16 md:h-20 hover:shadow-md hover:border-[#573865]/20 transition-all">
                <img src="./assets/nykaa.webp" alt="Nykaa"  loading="lazy" decoding="async" width="250" height="150" class="max-h-10 md:max-h-14 max-w-full object-contain" />
              </div>
            </div>

            <div class="flex-shrink-0 basis-1/2 sm:basis-1/3 lg:basis-1/5 px-1.5 md:px-2">
              <div class="bg-white rounded-xl border border-gray-200 flex items-center justify-center p-3 md:p-4 h-16 md:h-20 hover:shadow-md hover:border-[#573865]/20 transition-all">
                <img src="./assets/flipkart.webp" alt="Flipkart"  loading="lazy" decoding="async" width="250" height="150" class="max-h-10 md:max-h-14 max-w-full object-contain" />
              </div>
            </div>

            <!-- Add more logos here (unique ones only). No need to manually duplicate for loop. -->
          </div>

          <!-- ROW 2 TRACK -->
          <div
            class="recruitersTrack flex transition-transform duration-500 ease-in-out"
            data-recruiters-track="row2"
            style="transform: translateX(0px);"
          >
            <div class="flex-shrink-0 basis-1/2 sm:basis-1/3 lg:basis-1/5 px-1.5 md:px-2">
              <div class="bg-white rounded-xl border border-gray-200 flex items-center justify-center p-3 md:p-4 h-16 md:h-20 hover:shadow-md hover:border-[#573865]/20 transition-all">
                <img src="./assets/mother-dairy.webp" alt="Mother Dairy"  loading="lazy" decoding="async" width="250" height="150" class="max-h-10 md:max-h-14 max-w-full object-contain" />
              </div>
            </div>

            <div class="flex-shrink-0 basis-1/2 sm:basis-1/3 lg:basis-1/5 px-1.5 md:px-2">
              <div class="bg-white rounded-xl border border-gray-200 flex items-center justify-center p-3 md:p-4 h-16 md:h-20 hover:shadow-md hover:border-[#573865]/20 transition-all">
                <img src="./assets/croma.webp" alt="Croma"  loading="lazy" decoding="async" width="250" height="150" class="max-h-10 md:max-h-14 max-w-full object-contain" />
              </div>
            </div>

            <div class="flex-shrink-0 basis-1/2 sm:basis-1/3 lg:basis-1/5 px-1.5 md:px-2">
              <div class="bg-white rounded-xl border border-gray-200 flex items-center justify-center p-3 md:p-4 h-16 md:h-20 hover:shadow-md hover:border-[#573865]/20 transition-all">
                <img src="./assets/adani.webp" alt="Adani"  loading="lazy" decoding="async" width="250" height="150" class="max-h-10 md:max-h-14 max-w-full object-contain" />
              </div>
            </div>

            <div class="flex-shrink-0 basis-1/2 sm:basis-1/3 lg:basis-1/5 px-1.5 md:px-2">
              <div class="bg-white rounded-xl border border-gray-200 flex items-center justify-center p-3 md:p-4 h-16 md:h-20 hover:shadow-md hover:border-[#573865]/20 transition-all">
                <img src="./assets/ht-media.webp" alt="HT Media"  loading="lazy" decoding="async" width="250" height="150" class="max-h-10 md:max-h-14 max-w-full object-contain" />
              </div>
            </div>

            <div class="flex-shrink-0 basis-1/2 sm:basis-1/3 lg:basis-1/5 px-1.5 md:px-2">
              <div class="bg-white rounded-xl border border-gray-200 flex items-center justify-center p-3 md:p-4 h-16 md:h-20 hover:shadow-md hover:border-[#573865]/20 transition-all">
                <img src="./assets/Blue-dart.webp" alt="Blue Dart"  loading="lazy" decoding="async" width="250" height="150" class="max-h-10 md:max-h-14 max-w-full object-contain" />
              </div>
            </div>

            <div class="flex-shrink-0 basis-1/2 sm:basis-1/3 lg:basis-1/5 px-1.5 md:px-2">
              <div class="bg-white rounded-xl border border-gray-200 flex items-center justify-center p-3 md:p-4 h-16 md:h-20 hover:shadow-md hover:border-[#573865]/20 transition-all">
                <img src="./assets/sbi-life.webp" alt="SBI Life"  loading="lazy" decoding="async" width="250" height="150" class="max-h-10 md:max-h-14 max-w-full object-contain" />
              </div>
            </div>

            <div class="flex-shrink-0 basis-1/2 sm:basis-1/3 lg:basis-1/5 px-1.5 md:px-2">
              <div class="bg-white rounded-xl border border-gray-200 flex items-center justify-center p-3 md:p-4 h-16 md:h-20 hover:shadow-md hover:border-[#573865]/20 transition-all">
                <img src="./assets/make-my-trip.webp" alt="MakeMyTrip"  loading="lazy" decoding="async" width="250" height="150" class="max-h-10 md:max-h-14 max-w-full object-contain" />
              </div>
            </div>
      ...
      <!-- Dots (optional). With autoplay, you can remove this block if you want. -->
      <div id="recruitersDots" class="flex justify-center gap-2 mt-6"></div>
    </div>
  </div>
</section>

            <section id="program" class="py-6 md:py-5 bg-white scroll-mt-20">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="text-center mb-10 md:mb-8">
                        <h2 class="text-2xl md:text-3xl lg:text-4xl font-bold text-[#573865] mb-3">Program Snapshot</h2>
                       <!--  <p class="text-muted-foreground">How learning works at Jaipuria Online</p> -->
                    </div>
                    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
                        <div class="bg-gradient-to-br from-[#573865] to-[#6b4a7a] rounded-2xl p-6 text-white">
                            <svg
                                ...
                                class="lucide lucide-clock w-8 h-8 mb-4 text-[#f5a623]"
                            >
                                <circle cx="12" cy="12" r="10"></circle>
                                <polyline points="12 6 12 12 16 14"></polyline>
                            </svg>
                            <h3 class="text-xl font-bold mb-2">24 Months</h3>
                            <p class="text-white/70 text-sm">4 Semesters | Weekend Classes</p>
                        </div>
                        <div class="bg-gray-50 rounded-2xl p-6 border border-gray-100">
                            <svg
                                ...
                                stroke-linecap="round"
                                stroke-linejoin="round"
                                class="lucide lucide-user-check w-8 h-8 mb-4 text-[#573865]"
                            >
                                <path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"></path>
                                <circle cx="9" cy="7" r="4"></circle>
                                <polyline points="16 11 18 13 22 9"></polyline>
                            </svg>
                            <h3 class="text-xl font-bold text-[#573865] mb-2">1:1 Mentorship</h3>
                            <p class="text-muted-foreground text-sm">Personal guidance from industry experts</p>
                        </div>
                        <div class="bg-gray-50 rounded-2xl p-6 border border-gray-100">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                ...
                                stroke-linecap="round"
                                stroke-linejoin="round"
                                class="lucide lucide-laptop w-8 h-8 mb-4 text-[#573865]"
                            >
                                <path
                                    d="M20 16V7a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v9m16 0H4m16 0 1.28 2.55a1 1 0 0 1-.9 1.45H3.62a1 1 0 0 1-.9-1.45L4 16"
                                ></path>
                            </svg>
                            <h3 class="text-xl font-bold text-[#573865] mb-2">Live Projects &amp; Simulations</h3>
                            <p class="text-muted-foreground text-sm">Real-world business case studies</p>
                        </div>
                        <div class="bg-gray-50 rounded-2xl p-6 border border-gray-100">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                ...
                                stroke-linecap="round"
                                stroke-linejoin="round"
                                class="lucide lucide-calendar w-8 h-8 mb-4 text-[#573865]"
                            >
                                <path d="M8 2v4"></path>
                                <path d="M16 2v4"></path>
                            ...
                            <h3 class="text-xl font-bold text-[#573865] mb-2">8-10 Hours/Week</h3>
                            <p class="text-muted-foreground text-sm">Designed for working professionals</p>
                        </div>
                        <div class="bg-gray-50 rounded-2xl p-6 border border-gray-100">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                ...
                                stroke-linecap="round"
                                stroke-linejoin="round"
                                class="lucide lucide-globe w-8 h-8 mb-4 text-[#573865]"
                            >
                                <circle cx="12" cy="12" r="10"></circle>
                                <path d="M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20"></path>
                                <path d="M2 12h20"></path>
                            </svg>
                            <h3 class="text-xl font-bold text-[#573865] mb-2">AI-Driven Learning</h3>
                            <p class="text-muted-foreground text-sm">Modern LMS with adaptive learning</p>
                        </div>
                        <div class="bg-gradient-to-br from-[#f5a623] to-[#e09620] rounded-2xl p-6 text-white">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="24"
                                height="24"
                                ...
                                stroke-linecap="round"
                                stroke-linejoin="round"
                                class="lucide lucide-book-open w-8 h-8 mb-4"
                            >
                            ...
                            <h3 class="text-xl font-bold mb-2">5 Specializations</h3>
                            <p class="text-white/90 text-sm">Marketing, Finance, HR, Operations, Analytics</p>
                        </div>
                    </div>
                </div>
            </section>

        <section id="curriculum" class="py-12 md:py-10 bg-gray-50 scroll-mt-20">
  <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="text-center mb-10 md:mb-8">
      <h2 class="text-2xl md:text-3xl lg:text-4xl font-bold text-[#573865] mb-3">
        Curriculum Designed for Real Results
      </h2>
    </div>

    <div class="space-y-3" data-accordion="curriculum">
      <!-- Item 1 (VISIBLE by default) -->
      <div class="border border-gray-200 rounded-xl overflow-hidden bg-white">
        <button
          type="button"
          class="w-full flex items-center justify-between p-4 md:p-5 hover:bg-gray-50 transition-colors text-left"
          data-acc-trigger
          aria-expanded="false"
          aria-controls="sem1"
        >
          <span class="font-semibold text-[#573865]">Semester 1: Foundation</span>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            class="acc-icon lucide lucide-chevron-down w-5 h-5 text-gray-400 transition-transform">
            <path d="m6 9 6 6 6-6"></path>
          </svg>
        </button>

        <div id="sem1" class="acc-panel px-4 md:px-5 pb-4 md:pb-5" hidden>
      ...
      <!-- HIDDEN ITEMS WRAP -->
      <div id="curriculumMore" class="space-y-3 hidden">
        <!-- Item 2 -->
        <div class="border border-gray-200 rounded-xl overflow-hidden bg-white">
          <button
            type="button"
            ...
            aria-controls="sem2"
          >
            <span class="font-semibold text-[#573865]">Semester 2: Core Business</span>
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
              stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
              class="acc-icon lucide lucide-chevron-down w-5 h-5 text-gray-400 transition-transform">
              <path d="m6 9 6 6 6-6"></path>
          ...
          <div id="sem2" class="acc-panel px-4 md:px-5 pb-4 md:pb-5" hidden>
            <ul class="grid md:grid-cols-2 gap-2 text-sm text-gray-600">
        ...
        <div class="border border-gray-200 rounded-xl overflow-hidden bg-white">
          <button
            ...
            aria-controls="sem3"
          >
            <span class="font-semibold text-[#573865]">Semester 3: Specialization</span>
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
              stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
              class="acc-icon lucide lucide-chevron-down w-5 h-5 text-gray-400 transition-transform">
              <path d="m6 9 6 6 6-6"></path>
          ...
          <div id="sem3" class="acc-panel px-4 md:px-5 pb-4 md:pb-5" hidden>
            <div class="text-sm text-gray-600 mb-3">
              Choose electives aligned to your specialization.
            </div>
            <ul class="grid md:grid-cols-2 gap-2 text-sm text-gray-600">
              <li>• Advanced Marketing / Digital</li>
              <li>• Corporate Finance / Investments</li>
              <li>• People Analytics / Talent</li>
              <li>• Supply Chain / Ops Analytics</li>
              <li>• Business Analytics Foundations</li>
              <li>• Industry Project 1</li>
            </ul>
          </div>
        </div>
        ...
        <div class="border border-gray-200 rounded-xl overflow-hidden bg-white">
          <button
            ...
            aria-controls="sem4"
          >
            <span class="font-semibold text-[#573865]">Semester 4: Capstone</span>
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
              stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
              class="acc-icon lucide lucide-chevron-down w-5 h-5 text-gray-400 transition-transform">
              <path d="m6 9 6 6 6-6"></path>
          ...
          <div id="sem4" class="acc-panel px-4 md:px-5 pb-4 md:pb-5" hidden>
            <ul class="grid md:grid-cols-2 gap-2 text-sm text-gray-600">
              <li>• Strategy & Leadership</li>
              <li>• Business Ethics & Governance</li>
              <li>• Industry Project 2</li>
              <li>• Capstone Project</li>
              <li>• Career Readiness</li>
              <li>• Viva / Final Evaluation</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="pt-2">
  <button
  id="curriculumLoadMore"
  type="button"
  class="mx-auto flex items-center gap-2 px-4 py-2 text-sm rounded-lg bg-[#573865] text-white font-medium hover:bg-[#4b2f57] transition-colors"
  aria-expanded="false"
  aria-controls="curriculumMore"
>
  Read More
  <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 transition-transform" viewBox="0 0 24 24" fill="none"
    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    <path d="m6 9 6 6 6-6"></path>
  </svg>
</button>
           ...
           <!--  <section class="py-12 md:py-10 bg-white">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div
                        class="relative rounded-2xl overflow-hidden bg-gradient-to-r from-[#573865] to-[#6b4a7a] p-8 md:p-12 lg:p-16"
                    >
                        <div class="relative z-10 text-center text-white">
                            <svg
                                ...
                                stroke-linecap="round"
                                stroke-linejoin="round"
                                class="lucide lucide-graduation-cap w-16 h-16 mx-auto mb-4 text-[#f5a623]"
                            >
                                <path
                            ...
                            <h3 class="text-2xl md:text-3xl font-bold mb-3">Earn Your Online PGDM Degree from Jaipuria</h3>
                            <p class="text-white/70 max-w-2xl mx-auto mb-6">
                                Same rigorous curriculum and degree as on-campus program, delivered online for working
                                professionals
                            </p>
                            <div class="flex flex-wrap justify-center gap-4">
                                <div class="bg-white/10 backdrop-blur-sm rounded-lg px-4 py-2 border border-white/20">
                                    <span class="text-sm">UGC Recognized</span>
                                </div>
                                <div class="bg-white/10 backdrop-blur-sm rounded-lg px-4 py-2 border border-white/20">
                                    <span class="text-sm">AICTE Approved</span>
                                </div>
                                <div class="bg-white/10 backdrop-blur-sm rounded-lg px-4 py-2 border border-white/20">
                                    <span class="text-sm">At-par with Campus</span>
                                </div>
                            </div>
                        </div>
                        <div class="absolute top-0 right-0 w-64 h-64 bg-[#f5a623]/10 rounded-full blur-3xl"></div>
                        <div class="absolute bottom-0 left-0 w-64 h-64 bg-white/5 rounded-full blur-3xl"></div>
                    </div>
                </div>
            </section> -->
         <section id="Eligibility" class="py-12 md:py-10 bg-white">
  <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">

    <div class="text-center mb-8">
      <h2 class="text-2xl md:text-3xl lg:text-4xl font-bold text-[#573865]">
        Eligibility
      </h2>
    </div>

    <p class="text-sm text-gray-600 leading-relaxed text-center">
      3-year Bachelor’s degree in any discipline with at least 50% marks or equivalent CGPA
      from a recognized University or Institution as per the UGC Act, 1956, or possess an
      equivalent qualification recognized by the Ministry of Education, Government of India.
    </p>

  </div>
</section>

            <!-- SUCCESS STORIES (with modal video popup) -->
<section id="success-stories" class="py-6 md:py-5 bg-gray-50 scroll-mt-20 mb-8">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="text-center mb-10 md:mb-8">
      <h2 class="text-2xl md:text-3xl lg:text-4xl font-bold text-[#573865] mb-3">Success Stories</h2>
<!--       <p class="text-muted-foreground">Hear from our alumni</p> -->
    </div>

    <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-5 md:gap-6">
      <!-- Card 1 -->
      <div class="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-lg transition-shadow group">
        <div
          class="relative aspect-video cursor-pointer overflow-hidden"
          data-modal-trigger
          data-title="Richa's Journey"
          data-video="https://www.youtube.com/embed/aHaP9kanqlw?autoplay=1"
          role="button"
          tabindex="0"
          aria-label="Play Richa's Journey video"
        >
          <img
            src="assets/testimonial-richa.webp" alt="Richa" loading="lazy" decoding="async" width="600" height="338" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"
          />
          <div class="absolute inset-0 bg-black/20 group-hover:bg-black/30 transition-colors flex items-center justify-center">
            <div class="w-14 h-14 bg-[#573865] rounded-full flex items-center justify-center group-hover:bg-[#f5a623] transition-colors shadow-lg">
        ...
        <div class="p-4">
          <h4 class="font-semibold text-[#573865]">Richa</h4>
          <p class="text-sm text-muted-foreground mt-1 line-clamp-2">Restarting a Career with Jaipuria's Online PGDM</p>
        </div>
      </div>
      ...
      <div class="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-lg transition-shadow group">
        <div
          class="relative aspect-video cursor-pointer overflow-hidden"
          data-modal-trigger
          data-title="Ishani Chakravarti"
          data-video="https://www.youtube.com/embed/i74KP9DdTT0?autoplay=1"
          role="button"
          tabindex="0"
          aria-label="Play Ishani's Journey video"
        >
          <img
            src="assets/testimonial-ishani.webp" alt="Ishani" loading="lazy" decoding="async" width="600" height="338" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"
          />
          <div class="absolute inset-0 bg-black/20 group-hover:bg-black/30 transition-colors flex items-center justify-center">
            <div class="w-14 h-14 bg-[#573865] rounded-full flex items-center justify-center group-hover:bg-[#f5a623] transition-colors shadow-lg">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="white"
        ...
        <div class="p-4">
          <h4 class="font-semibold text-[#573865]">Ishani Chakravarti</h4>
          <p class="text-sm text-muted-foreground mt-1 line-clamp-2">How Jaipuria Online MBA is Boosting Business Growth</p>
        </div>
      </div>
      ...
      <div class="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-lg transition-shadow group">
        <div
          class="relative aspect-video cursor-pointer overflow-hidden"
          data-modal-trigger
          data-title="Sanjay Batra"
          data-video="https://www.youtube.com/embed/6GJSvn_FFoY?autoplay=1"
          role="button"
          tabindex="0"
          aria-label="Play Sanjay's Journey video"
        >
          <img src="assets/testimonial-sanjay.webp" alt="Sanjay" loading="lazy" decoding="async" width="600" height="338" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"
          />
          <div class="absolute inset-0 bg-black/20 group-hover:bg-black/30 transition-colors flex items-center justify-center">
            <div class="w-14 h-14 bg-[#573865] rounded-full flex items-center justify-center group-hover:bg-[#f5a623] transition-colors shadow-lg">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="white"
        ...
        <div class="p-4">
          <h4 class="font-semibold text-[#573865]">Sanjay Batra</h4>
          <p class="text-sm text-muted-foreground mt-1 line-clamp-2">How Jaipuria Online PGDM Transformed Business Approach</p>
        </div>
      </div>
      ...
      <div class="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-lg transition-shadow group">
        <div
          class="relative aspect-video cursor-pointer overflow-hidden"
          data-modal-trigger
          data-title="Karishma Rawat"
          data-video="https://www.youtube.com/embed/t-b0Xic5O7E?autoplay=1"
          role="button"
          tabindex="0"
          aria-label="Play Karishma's Journey video"
        >
          <img src="assets/testimonial-karishma.webp" alt="Karishma" loading="lazy" decoding="async" width="600" height="338" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"
          />
          <div class="absolute inset-0 bg-black/20 group-hover:bg-black/30 transition-colors flex items-center justify-center">
            <div class="w-14 h-14 bg-[#573865] rounded-full flex items-center justify-center group-hover:bg-[#f5a623] transition-colors shadow-lg">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="white"
        ...
        <div class="p-4">
          <h4 class="font-semibold text-[#573865]">Karishma Rawat</h4>
          <p class="text-sm text-muted-foreground mt-1 line-clamp-2">Redefining Career Growth with Jaipuria Online PGDM</p>
        </div>
      </div>
    </div>
  </div>
...
<div class="grid grid-cols-3 gap-4 md:gap-6 max-w-3xl mx-auto">

 
<div class="bg-white rounded-xl p-4 flex flex-col items-center justify-center shadow-sm border border-gray-100">
  <img
    src="assets/NIRF-Ministry-of-Education.webp"
    alt="NIRF Rank 41"
    class="h-12 md:h-14 w-auto object-contain mb-2"
  />
  <span class="text-xs md:text-sm font-semibold text-[#573865]">
    #41 NIRF Rank
  </span>
</div>
  ...
  <div class="bg-white rounded-xl p-4 flex flex-col items-center justify-center shadow-sm border border-gray-100">
    <img
      src="assets/aacsb-logo.webp"
      alt="AACSB Accredited"
      class="h-10 md:h-12 w-auto object-contain mb-2"
    />
    <span class="text-xs md:text-sm font-semibold text-[#573865]">
      AACSB Accredited
    </span>
...
<footer class="bg-[#e7e7e7] py-6 md:py-4">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
  <p class="font-medium text-center text-gray-700 text-[0.7rem] leading-[1rem]">
      All programs listed here are subject to approval of the Jaipuria Institute of Management.<br>
      Jaipuria reserves the right to introduce/discontinue/modify new/existing programs at its sole discretion, without prior intimation to any party.<br>
      <b>Disclaimer:</b> Jaipuria Institute of Management operates campuses at Noida, Lucknow, Jaipur, and Indore under the same group and governance. The Jaipuria Institute of Management campuses mentioned above are not affiliated with or associated with any other higher education/management institute using the “Jaipuria” name, including business institutes located in Ghaziabad or operated by other groups.

    </p>
  </div>
</footer>

<a href="#apply-now" id="floatingApplyNow" class="floating-apply-now" aria-label="Apply Now">
  <span>APPLY NOW</span>
</a>
 

<!-- VIDEO MODAL (replace your existing modal with this) -->
<div id="videoModal" class="fixed inset-0 z-[9999] hidden" aria-hidden="true">
  <!-- Backdrop -->
  ...
  <div class="relative h-full w-full flex items-center justify-center p-4">
    <div class="relative w-full max-w-4xl">
      ...
      <button
        type="button"
        class="absolute -top-4 -right-4 w-10 h-10 rounded-full bg-white shadow-lg flex items-center justify-center hover:bg-gray-100"
        aria-label="Close"
        data-modal-close style="right:0;"
      >
        ✕
      </button>
      ...
      <div class="bg-white rounded-2xl overflow-hidden shadow-2xl">
        <!-- Header -->
        <div class="px-4 md:px-6 py-3 border-b">
          <div id="videoModalTitle" class="font-semibold text-[#573865]">Success Story</div>
        </div>
...
(function () {
  ...
  function initInfiniteTrack(track) {
    ...
    const first = items[0];
    let itemWidth = first.getBoundingClientRect().width;
    let gap = getGapPx(first);

    // Clone items for seamless loop
    const viewport = track.parentElement;
    const viewportWidth = viewport.getBoundingClientRect().width;
    const clonesNeeded = Math.ceil(viewportWidth / (itemWidth + gap)) + 2;
  ...
  // Init both rows independently
  const instances = tracks.map(initInfiniteTrack);

  // Manual controls move BOTH rows together
...
(function () {
  ...
  triggers.forEach((btn) => {
    btn.addEventListener("click", () => {
      ...
      btn.closest("div.border")?.classList.toggle("acc-open", !isOpen);
      panel.hidden = isOpen;
    });
  });
})();
...
(function () {
  ...
  if (titleEl) titleEl.textContent = title || "Success Story";
  frame.src = videoUrl;
...
<style type="text/css">
  ...
  45% {
    ...
    text-shadow:
      ...
      0 0 26px rgba(245,166,35,0.7);
  }
  55% {
    opacity: 0.75;
    text-shadow:
      0 0 22px rgba(245,166,35,1),
      0 0 38px rgba(245,166,35,0.95);
  }
  65% {
    opacity: 0.9;
    text-shadow:
...
.flicker-strong {
  animation: strongFlicker 2s infinite ease-in-out;
}


.career-marquee { position: relative; overflow: hidden; }
...
.career-track{
  ...
  flex-wrap: nowrap;
  align-items: stretch;
  gap: 16px;                 /* keep a consistent gap */
  will-change: transform;
  transform: translate3d(0,0,0);
}

/* Each item will be sized by JS to exactly 1/5th */
.career-item{
  flex: 0 0 auto;
...
height: 112px;
  ...
  border-radius: 0 0 22px 0; /* ONLY bottom-right */
}
...
.floating-apply-now span{
  display: inline-block;
  writing-mode: vertical-rl;
  transform: rotate(180deg); /* reads bottom-to-top like screenshot */
  font-weight: 800;
  letter-spacing: .12em;
  font-size: 16px;
  line-height: 1;
...
.floating-apply-now.is-visible{
  opacity: 1;
  visibility: visible;
  pointer-events: auto;
  transform: translateY(-50%); /* keep position stable */
}
...
(function () {
  function initRecruitersAutoScroll() {
    const tracks = document.querySelectorAll(".recruitersTrack");
    const nextBtn = document.getElementById("recruitersNext");
    const prevBtn = document.getElementById("recruitersPrev");

    if (!tracks.length) return;

    // Find the shared viewport (your overflow-hidden wrapper)
    const viewport = tracks[0].closest(".overflow-hidden");
    if (!viewport) return;

    let x = 0;
    let timer = null;
    const DELAY = 2500; // autoplay speed (ms)
    const DURATION = 600; // slide animation (ms)

    // Ensure smooth transition (even if tailwind class fails)
    tracks.forEach(t => {
    ...
    function metrics() {
      const step = viewport.clientWidth; // move by viewport width (page-wise)
      const maxTranslate = Math.max(0, tracks[0].scrollWidth - viewport.clientWidth);
    ...
    function next() {
      const { step, maxTranslate } = metrics();

      // If widths not ready yet, skip this tick
      if (!step) return;

      x += step;

      // loop back
      if (x > maxTranslate + 2) x = 0;
  ...
  // IMPORTANT: wait for full load so widths are correct
  window.addEventListener("load", initRecruitersAutoScroll);
})();
</script>
...
function visibleCount() {
  ...
  if (w < 768) return 2;   // all mobiles = 2 cards
  return 5;                // desktop
}
  function applySizes() {
    items = Array.from(track.querySelectorAll(".career-item"));

    const vw = marquee.clientWidth;   // IMPORTANT: viewport width, not window
    const gap = window.innerWidth < 768 ? 12 : 16;

    const visible = visibleCount();
    const cardW = Math.floor((vw - gap * (visible - 1)) / visible);

    // Make the track behave like a row with spacing
    track.style.display = "flex";
    track.style.gap = gap + "px";
    track.style.willChange = "transform";

    // CRITICAL: set flex-basis (not just width), so cards don't stretch
    items.forEach((item) => {
      item.style.flex = `0 0 ${cardW}px`;
      item.style.width = `${cardW}px`;
    });

    // Reset position on resize so it doesn't get stuck mid-way
    x = 0;
  ...
  function tick(ts) {
    ...
    const half = track.scrollWidth / 2; // because you duplicated the set
    x -= SPEED * dt;

    // reset when the first set fully passed
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  btn.addEventListener("click", function () {
    ...
    if (!expanded) {
      ...
      btn.innerHTML = `
        Show Less
        <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 rotate-180 transition-transform" viewBox="0 0 24 24" fill="none"
          stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          <path d="m6 9 6 6 6-6"></path>
        </svg>
      `;
...
(function () {
  ...
  const SHOW_AFTER_PX = 250; // show after user scrolls a bit
  ...
  function update() {
    ...
    // Visible only when scrolled AND form is NOT in view
    if (scrolled && !formInView) btn.classList.add('is-visible');
...
['scroll','mousemove','touchstart'].forEach(e =>
  window.addEventListener(e, loadDeferredScripts, { once:true })
);
</script>
